package org.example.contentplugin.elementalproject.contents.playerSkill.iceSkill.martial;
...
public class FrozenPunch extends Reaction implements BaseAttack {
    @Override
