package org.example.contentplugin.elementalproject.contents.playerSkill.electronicSkill.mage;
...
public class ElectronicChain extends Reaction implements BaseAttack {
    @Override
