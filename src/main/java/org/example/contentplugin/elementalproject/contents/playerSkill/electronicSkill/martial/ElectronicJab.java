package org.example.contentplugin.elementalproject.contents.playerSkill.electronicSkill.martial;
...
public class ElectronicJab extends Reaction implements BaseAttack {
    @Override
