package org.example.contentplugin.elementalproject.contents.playerSkill.lightSkill.sword;
...
public class LightSlash extends Reaction implements BaseAttack {
    @Override
