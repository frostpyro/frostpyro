package org.example.contentplugin.elementalproject.contents.playerSkill.lightSkill.archer;
...
public class LightShot extends Reaction implements BaseAttack {
    @Override
